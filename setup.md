...
`./03_私について/my_profile.md` を作成します。
以下の7問を私に順番に聞いてください。全問答え終わったら、回答を整理してmy_profile.mdに書き込んでください。

質問：
1. あなたの名前（ニックネームでもOK）と、今やっている仕事・活動を教えてください
2. あなたが今一番解決したい課題・悩みは何ですか？
3. 3年後にどんな状態になっていたいですか？（収入・働き方・生活など）
4. 今使っているSNSやビジネスツールを教えてください（X・note・LINE等）
5. AIに一番やってほしいことは何ですか？（例：タスク管理・投稿生成・情報整理）
6. 絶対にAIにやってほしくないこと・注意してほしいことはありますか？
7. あなたのビジネスの「核心的な強み」を一言で言うと何ですか？
